...
export default function ServicioItem({ data, openModal }: {data: ServicioModel, openModal: (serviceId: string) => void}) {
  return (
    <Card>
      <CardHeader className="flex flex-col gap-2 items-start">
        <div className="flex items-center justify-between w-full">
          <div className="flex justify-between items-center gap-2">
            ...
            <p className="font-bold text-lg">{`${data.clientes.nombre} ${data.clientes.apellido}`}</p>
          </div>
